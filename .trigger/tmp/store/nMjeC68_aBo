...
async function fileFromPath2(path, ...args) {
  const { fileFromPath: _fileFromPath } = await import("./fileFromPath-E3PRHQMV.mjs");
...
var AbstractPage = class {
  ...
  async getNextPage() {
    ...
    return await __classPrivateFieldGet4(this, _AbstractPage_client, "f").requestAPIList(this.constructor, nextOptions);
  }
  async *iterPages() {
    let page = this;
    yield page;
...
var BetaMessageStream = class _BetaMessageStream {
  ...
  constructor() {
    ...
    _BetaMessageStream_handleError.set(this, (error) => {
      __classPrivateFieldSet4(this, _BetaMessageStream_errored, true, "f");
      if (error instanceof Error && error.name === "AbortError") {
        error = new APIUserAbortError();
      }
      if (error instanceof APIUserAbortError) {
        __classPrivateFieldSet4(this, _BetaMessageStream_aborted, true, "f");
    ...
    __classPrivateFieldSet4(this, _BetaMessageStream_connectedPromise, new Promise((resolve, reject) => {
      __classPrivateFieldSet4(this, _BetaMessageStream_resolveConnectedPromise, resolve, "f");
      __classPrivateFieldSet4(this, _BetaMessageStream_rejectConnectedPromise, reject, "f");
    }), "f");
    __classPrivateFieldSet4(this, _BetaMessageStream_endPromise, new Promise((resolve, reject) => {
      __classPrivateFieldSet4(this, _BetaMessageStream_resolveEndPromise, resolve, "f");
      __classPrivateFieldSet4(this, _BetaMessageStream_rejectEndPromise, reject, "f");
    }), "f");
    __classPrivateFieldGet5(this, _BetaMessageStream_connectedPromise, "f").catch(() => {
    });
    __classPrivateFieldGet5(this, _BetaMessageStream_endPromise, "f").catch(() => {
    });
  }
  get response() {
    return __classPrivateFieldGet5(this, _BetaMessageStream_response, "f");
  }
  get request_id() {
    return __classPrivateFieldGet5(this, _BetaMessageStream_request_id, "f");
  }
  /**
   ...
   */
  async withResponse() {
    const response = await __classPrivateFieldGet5(this, _BetaMessageStream_connectedPromise, "f");
    if (!response) {
  ...
  _run(executor) {
    executor().then(() => {
      this._emitFinal();
      this._emit("end");
    }, __classPrivateFieldGet5(this, _BetaMessageStream_handleError, "f"));
  }
  ...
  async _createMessage(messages, params, options) {
    ...
    __classPrivateFieldGet5(this, _BetaMessageStream_instances, "m", _BetaMessageStream_beginRequest).call(this);
    const { response, data: stream } = await messages.create({ ...params, stream: true }, { ...options, signal: this.controller.signal }).withResponse();
    this._connected(response);
    for await (const event of stream) {
      __classPrivateFieldGet5(this, _BetaMessageStream_instances, "m", _BetaMessageStream_addStreamEvent).call(this, event);
    }
    if (stream.controller.signal?.aborted) {
      throw new APIUserAbortError();
    }
    __classPrivateFieldGet5(this, _BetaMessageStream_instances, "m", _BetaMessageStream_endRequest).call(this);
  }
  _connected(response) {
    if (this.ended)
      return;
    __classPrivateFieldSet4(this, _BetaMessageStream_response, response, "f");
    __classPrivateFieldSet4(this, _BetaMessageStream_request_id, response?.headers.get("request-id"), "f");
    __classPrivateFieldGet5(this, _BetaMessageStream_resolveConnectedPromise, "f").call(this, response);
    this._emit("connect");
  }
  get ended() {
    return __classPrivateFieldGet5(this, _BetaMessageStream_ended, "f");
  }
  get errored() {
    return __classPrivateFieldGet5(this, _BetaMessageStream_errored, "f");
  }
  get aborted() {
    return __classPrivateFieldGet5(this, _BetaMessageStream_aborted, "f");
  }
  abort() {
    this.controller.abort();
  }
   ...
   */
  on(event, listener) {
    const listeners = __classPrivateFieldGet5(this, _BetaMessageStream_listeners, "f")[event] || (__classPrivateFieldGet5(this, _BetaMessageStream_listeners, "f")[event] = []);
   ...
   */
  off(event, listener) {
    const listeners = __classPrivateFieldGet5(this, _BetaMessageStream_listeners, "f")[event];
    if (!listeners)
      return this;
  ...
  emitted(event) {
    return new Promise((resolve, reject) => {
      __classPrivateFieldSet4(this, _BetaMessageStream_catchingPromiseCreated, true, "f");
      if (event !== "error")
  ...
  async done() {
    __classPrivateFieldSet4(this, _BetaMessageStream_catchingPromiseCreated, true, "f");
    await __classPrivateFieldGet5(this, _BetaMessageStream_endPromise, "f");
  }
  get currentMessage() {
    return __classPrivateFieldGet5(this, _BetaMessageStream_currentMessageSnapshot, "f");
  }
  /**
  ...
  async finalMessage() {
    await this.done();
    return __classPrivateFieldGet5(this, _BetaMessageStream_instances, "m", _BetaMessageStream_getFinalMessage).call(this);
  }
  /**
  ...
  async finalText() {
    await this.done();
    return __classPrivateFieldGet5(this, _BetaMessageStream_instances, "m", _BetaMessageStream_getFinalText).call(this);
  }
  _emit(event, ...args) {
    if (__classPrivateFieldGet5(this, _BetaMessageStream_ended, "f"))
      return;
    if (event === "end") {
      __classPrivateFieldSet4(this, _BetaMessageStream_ended, true, "f");
      __classPrivateFieldGet5(this, _BetaMessageStream_resolveEndPromise, "f").call(this);
    }
    const listeners = __classPrivateFieldGet5(this, _BetaMessageStream_listeners, "f")[event];
    if (listeners) {
      __classPrivateFieldGet5(this, _BetaMessageStream_listeners, "f")[event] = listeners.filter((l) => !l.once);
      listeners.forEach(({ listener }) => listener(...args));
    }
    if (event === "abort") {
      const error = args[0];
      if (!__classPrivateFieldGet5(this, _BetaMessageStream_catchingPromiseCreated, "f") && !listeners?.length) {
        Promise.reject(error);
      }
      __classPrivateFieldGet5(this, _BetaMessageStream_rejectConnectedPromise, "f").call(this, error);
      __classPrivateFieldGet5(this, _BetaMessageStream_rejectEndPromise, "f").call(this, error);
      this._emit("end");
      return;
    }
    if (event === "error") {
  ...
  _emitFinal() {
    ...
    if (finalMessage) {
      this._emit("finalMessage", __classPrivateFieldGet5(this, _BetaMessageStream_instances, "m", _BetaMessageStream_getFinalMessage).call(this));
    }
  }
  ...
  [(_BetaMessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_listeners = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_ended = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_errored = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_aborted = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_response = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_request_id = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_handleError = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_instances = /* @__PURE__ */ new WeakSet(), _BetaMessageStream_getFinalMessage = /* @__PURE__ */ __name(function _BetaMessageStream_getFinalMessage2() {
    ...
    if (this.ended)
      return;
    __classPrivateFieldSet4(this, _BetaMessageStream_currentMessageSnapshot, void 0, "f");
    ...
    if (this.ended)
      return;
    const messageSnapshot = __classPrivateFieldGet5(this, _BetaMessageStream_instances, "m", _BetaMessageStream_accumulateMessage).call(this, event);
    ...
    switch (event.type) {
      ...
      case "message_start": {
        __classPrivateFieldSet4(this, _BetaMessageStream_currentMessageSnapshot, messageSnapshot, "f");
        break;
      }
    ...
    const snapshot = __classPrivateFieldGet5(this, _BetaMessageStream_currentMessageSnapshot, "f");
    if (!snapshot) {
    ...
    let snapshot = __classPrivateFieldGet5(this, _BetaMessageStream_currentMessageSnapshot, "f");
...
var MessageStream = class _MessageStream {
  ...
  constructor() {
    ...
    _MessageStream_handleError.set(this, (error) => {
      __classPrivateFieldSet5(this, _MessageStream_errored, true, "f");
      if (error instanceof Error && error.name === "AbortError") {
        error = new APIUserAbortError();
      }
      if (error instanceof APIUserAbortError) {
        __classPrivateFieldSet5(this, _MessageStream_aborted, true, "f");
        return this._emit("abort", error);
      }
      if (error instanceof AnthropicError) {
        return this._emit("error", error);
    ...
    __classPrivateFieldSet5(this, _MessageStream_connectedPromise, new Promise((resolve, reject) => {
      __classPrivateFieldSet5(this, _MessageStream_resolveConnectedPromise, resolve, "f");
      __classPrivateFieldSet5(this, _MessageStream_rejectConnectedPromise, reject, "f");
    }), "f");
    __classPrivateFieldSet5(this, _MessageStream_endPromise, new Promise((resolve, reject) => {
      __classPrivateFieldSet5(this, _MessageStream_resolveEndPromise, resolve, "f");
      __classPrivateFieldSet5(this, _MessageStream_rejectEndPromise, reject, "f");
    }), "f");
    __classPrivateFieldGet6(this, _MessageStream_connectedPromise, "f").catch(() => {
    });
    __classPrivateFieldGet6(this, _MessageStream_endPromise, "f").catch(() => {
    });
  }
  get response() {
    return __classPrivateFieldGet6(this, _MessageStream_response, "f");
  }
  get request_id() {
    return __classPrivateFieldGet6(this, _MessageStream_request_id, "f");
  }
  /**
   * Returns the `MessageStream` data, the raw `Response` instance and the ID of the request,
   * returned vie the `request-id` header which is useful for debugging requests and resporting
   ...
   */
  async withResponse() {
    const response = await __classPrivateFieldGet6(this, _MessageStream_connectedPromise, "f");
    if (!response) {
      throw new Error("Could not resolve a `Response` object");
    }
    return {
  ...
  _run(executor) {
    executor().then(() => {
      this._emitFinal();
      this._emit("end");
    }, __classPrivateFieldGet6(this, _MessageStream_handleError, "f"));
  }
  _addMessageParam(message) {
    this.messages.push(message);
  }
  ...
  async _createMessage(messages, params, options) {
    ...
    __classPrivateFieldGet6(this, _MessageStream_instances, "m", _MessageStream_beginRequest).call(this);
    const { response, data: stream } = await messages.create({ ...params, stream: true }, { ...options, signal: this.controller.signal }).withResponse();
    this._connected(response);
    for await (const event of stream) {
      __classPrivateFieldGet6(this, _MessageStream_instances, "m", _MessageStream_addStreamEvent).call(this, event);
    }
    if (stream.controller.signal?.aborted) {
      throw new APIUserAbortError();
    }
    __classPrivateFieldGet6(this, _MessageStream_instances, "m", _MessageStream_endRequest).call(this);
  }
  _connected(response) {
    if (this.ended)
      return;
    __classPrivateFieldSet5(this, _MessageStream_response, response, "f");
    __classPrivateFieldSet5(this, _MessageStream_request_id, response?.headers.get("request-id"), "f");
    __classPrivateFieldGet6(this, _MessageStream_resolveConnectedPromise, "f").call(this, response);
    this._emit("connect");
  }
  get ended() {
    return __classPrivateFieldGet6(this, _MessageStream_ended, "f");
  }
  get errored() {
    return __classPrivateFieldGet6(this, _MessageStream_errored, "f");
  }
  get aborted() {
    return __classPrivateFieldGet6(this, _MessageStream_aborted, "f");
  }
  abort() {
    this.controller.abort();
  }
   ...
   */
  on(event, listener) {
    const listeners = __classPrivateFieldGet6(this, _MessageStream_listeners, "f")[event] || (__classPrivateFieldGet6(this, _MessageStream_listeners, "f")[event] = []);
    listeners.push({ listener });
    return this;
  }
  /**
   ...
   */
  off(event, listener) {
    const listeners = __classPrivateFieldGet6(this, _MessageStream_listeners, "f")[event];
    if (!listeners)
      return this;
    const index = listeners.findIndex((l) => l.listener === listener);
    if (index >= 0)
  ...
  emitted(event) {
    return new Promise((resolve, reject) => {
      __classPrivateFieldSet5(this, _MessageStream_catchingPromiseCreated, true, "f");
      if (event !== "error")
        this.once("error", reject);
      this.once(event, resolve);
    });
  ...
  async done() {
    __classPrivateFieldSet5(this, _MessageStream_catchingPromiseCreated, true, "f");
    await __classPrivateFieldGet6(this, _MessageStream_endPromise, "f");
  }
  get currentMessage() {
    return __classPrivateFieldGet6(this, _MessageStream_currentMessageSnapshot, "f");
  }
  /**
   * @returns a promise that resolves with the the final assistant Message response,
   * or rejects if an error occurred or the stream ended prematurely without producing a Message.
  ...
  async finalMessage() {
    await this.done();
    return __classPrivateFieldGet6(this, _MessageStream_instances, "m", _MessageStream_getFinalMessage).call(this);
  }
  /**
   * @returns a promise that resolves with the the final assistant Message's text response, concatenated
   * together if there are more than one text blocks.
  ...
  async finalText() {
    await this.done();
    return __classPrivateFieldGet6(this, _MessageStream_instances, "m", _MessageStream_getFinalText).call(this);
  }
  _emit(event, ...args) {
    if (__classPrivateFieldGet6(this, _MessageStream_ended, "f"))
      return;
    if (event === "end") {
      __classPrivateFieldSet5(this, _MessageStream_ended, true, "f");
      __classPrivateFieldGet6(this, _MessageStream_resolveEndPromise, "f").call(this);
    }
    const listeners = __classPrivateFieldGet6(this, _MessageStream_listeners, "f")[event];
    if (listeners) {
      __classPrivateFieldGet6(this, _MessageStream_listeners, "f")[event] = listeners.filter((l) => !l.once);
      listeners.forEach(({ listener }) => listener(...args));
    }
    if (event === "abort") {
      const error = args[0];
      if (!__classPrivateFieldGet6(this, _MessageStream_catchingPromiseCreated, "f") && !listeners?.length) {
        Promise.reject(error);
      }
      __classPrivateFieldGet6(this, _MessageStream_rejectConnectedPromise, "f").call(this, error);
      __classPrivateFieldGet6(this, _MessageStream_rejectEndPromise, "f").call(this, error);
      this._emit("end");
      return;
    }
    if (event === "error") {
  ...
  _emitFinal() {
    const finalMessage = this.receivedMessages.at(-1);
    if (finalMessage) {
      this._emit("finalMessage", __classPrivateFieldGet6(this, _MessageStream_instances, "m", _MessageStream_getFinalMessage).call(this));
    }
  }
  async _fromReadableStream(readableStream, options) {
    const signal = options?.signal;
  ...
  [(_MessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _MessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_listeners = /* @__PURE__ */ new WeakMap(), _MessageStream_ended = /* @__PURE__ */ new WeakMap(), _MessageStream_errored = /* @__PURE__ */ new WeakMap(), _MessageStream_aborted = /* @__PURE__ */ new WeakMap(), _MessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _MessageStream_response = /* @__PURE__ */ new WeakMap(), _MessageStream_request_id = /* @__PURE__ */ new WeakMap(), _MessageStream_handleError = /* @__PURE__ */ new WeakMap(), _MessageStream_instances = /* @__PURE__ */ new WeakSet(), _MessageStream_getFinalMessage = /* @__PURE__ */ __name(function _MessageStream_getFinalMessage2() {
    ...
    if (this.ended)
      return;
    __classPrivateFieldSet5(this, _MessageStream_currentMessageSnapshot, void 0, "f");
  }, "_MessageStream_beginRequest"), _MessageStream_addStreamEvent = /* @__PURE__ */ __name(function _MessageStream_addStreamEvent2(event) {
    if (this.ended)
      return;
    const messageSnapshot = __classPrivateFieldGet6(this, _MessageStream_instances, "m", _MessageStream_accumulateMessage).call(this, event);
    this._emit("streamEvent", event, messageSnapshot);
    switch (event.type) {
      case "content_block_delta": {
        const content = messageSnapshot.content.at(-1);
      ...
      case "message_start": {
        __classPrivateFieldSet5(this, _MessageStream_currentMessageSnapshot, messageSnapshot, "f");
        break;
      }
      case "content_block_start":
      case "message_delta":
    ...
    const snapshot = __classPrivateFieldGet6(this, _MessageStream_currentMessageSnapshot, "f");
    if (!snapshot) {
      throw new AnthropicError(`request ended without sending any chunks`);
    }
    __classPrivateFieldSet5(this, _MessageStream_currentMessageSnapshot, void 0, "f");
    ...
    let snapshot = __classPrivateFieldGet6(this, _MessageStream_currentMessageSnapshot, "f");
    if (event.type === "message_start") {
      if (snapshot) {
        throw new AnthropicError(`Unexpected event order, got ${event.type} before receiving "message_stop"`);
      }
...
humanize-ms/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3B663HRG.mjs.map
